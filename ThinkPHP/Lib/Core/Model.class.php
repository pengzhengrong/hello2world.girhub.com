...
class Model {
    ...
    public function select($options=array()) {
        ...
        // my_log( 'resultSet' , json_encode( $resultSet ) );
        // my_log( 'options' , json_encode($options ) ); 
        // options={"link":true,"table":"think_user","model":"UserRelation"}
        my_log(  'resultset',json_encode( $resultSet ) );
    ...
    public function db($linkNum='',$config='',$params=array()){
        ...
        static $_db = array();
        // @error_log("\n config=$config",3,'/tmp/pzrlog.log'); // config=''
