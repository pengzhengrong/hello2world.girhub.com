...
if(!IS_CLI) {
    ...
    if(!defined('_PHP_FILE_')) {
        // @error_log("\n IS_CGI=".IS_CGI,3,"/tmp/pzrlog.log");// 0
        if(IS_CGI) {
            //CGI/FASTCGI模式下
            ...
            //@error_log("\n _PHP_FILE_="._PHP_FILE_,3,"/tmp/pzrlog.log");// /home.php
        }
    }
    if(!defined('__ROOT__')) {
        // 网站URL根目录
        ...
        // @error_log("\n __ROOT__=".__ROOT__ ,3,"/tmp/pzrlog.log");//  '  '
    }
...
// @error_log("\n get_include_path=".get_include_path() ,3,"/tmp/pzrlog.log"); //.:/usr/share/php:/usr/share/pear
set_include_path(get_include_path() . PATH_SEPARATOR . VENDOR_PATH);
// @error_log("\n get_include_path=".get_include_path() ,3,"/tmp/pzrlog.log");
//.:/usr/share/php:/usr/share/pear:/home/pzr/workspace/thinkphp/ThinkPHP/Extend/Vendor/
