...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="login">	
			<form action="<?php echo U('/Admin/Login/handle','','');?>" method="post" id="login">
			<div class="title">
				后盾网 | 登录后台
			</div>
			<table border="1" width="100%">
				...
				<tr>
					<th>验证码:</th>
					<td>
						<input type="code" class="len250" name="code"/> <img src="<?php echo U('Admin/Login/verify','','');?>" id="code"/> <a href="javascript:void();"  onclick="change_code(this)">看不清</a>
					</td>
				</tr>
				<tr>
