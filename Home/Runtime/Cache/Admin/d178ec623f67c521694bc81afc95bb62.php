...
<body>
	<div id="top">
		<div class="menu">
			<a href="<?php echo U('/Admin/WishMan/index');?>">wish manage</a>
			<a href="#">选择按钮</a>
			<a href="#">选择按钮</a>
			<a href="#">选择按钮</a>
			<a href="#">选择按钮</a>
	...
	<div id="left">
		<dl>
			<dt>Admin Manager</dt>
			<dd><a href="<?php echo U('Admin/WishMan/index');?>">wish manage</a></dd>
			<dd><a href="<?php echo U('Admin/Rbac/role');?>">ROLE</a></dd>
			<dd><a href="<?php echo U('Admin/Rbac/node');?>">NODE</a></dd>
			<dd><a href="<?php echo U('Admin/Rbac/access');?>">ACCESS</a></dd>
			<dd><a href="<?php echo U('Admin/User/index');?>">USER</a></dd>
		</dl>
		<dl>
			<dt>功能标题</dt>
			<dd><a href="#">功能标题</a></dd>
